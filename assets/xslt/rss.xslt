  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://MattPayne.org//">Start</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://MattPayne.org//getting-started/">Getting Started</a></li>
              <li class="divider"></li>
	...
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://mattpayne.org//" title="MattPayne.org – A Flexible Theme for Jekyll">
				<img src="http://MattPayne.org//assets/img/logo.png" alt="MattPayne.org – A Flexible Theme for Jekyll">
			</a>
