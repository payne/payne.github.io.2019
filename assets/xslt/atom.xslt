...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="https://MattPayne.org//assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="Random notes">
	<meta property="og:url" content="https://MattPayne.org//assets/xslt/atom.xslt">
	...
	<meta name="twitter:site" content="MattPayneOrg">
	<meta name="twitter:creator" content="MattPayneOrg">
	<meta name="twitter:title" content="Atom Feed (Styled)">
	<meta name="twitter:description" content="Random notes">
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Content currated or created by Matt Payne using <a href="http://jekyllrb.com/" target="_blank">Jekyll</a> based on <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a>.</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="http://github.com/payne" target="_blank" class="icon-github" title="My github is not my resume; it is a junk drawer."></a></li>
            
              <li><a href="http://twitter.com/MattPayneOrg" target="_blank" class="icon-twitter" title="Twitter is fun"></a></li>
